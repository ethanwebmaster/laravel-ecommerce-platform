...
@section('content')
                        ...
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-pills">
                                <li class="active"><a href="#edit_profile" data-toggle="pill"><i
                                                class="fa fa-pencil"></i> @lang('corals-admin::labels.auth.edit_profile')</a></li>
                                <li>
    ...
    @lang('corals-admin::labels.auth.browse_files')
                    ...
                    <button type="button" class="btn btn-default" data-dismiss="modal">@lang('corals-admin::labels.auth.close')</button>
                </div>
            </div>
        </div>
    </div>
@endsection
@section('js')
    {!! Theme::js('plugins/cropper/cropper.js') !!}
