...
//        Route::post('{product}/rate', 'ProductsController@createRating');
    ...
    Route::group(['prefix' => 'wishlist'], function () {
        Route::post('{product}', 'WishlistsPublicController@setWishlist');
        Route::delete('{wishlist}', 'WishlistsController@removeFromWhishlist');
        Route::get('my', ['as' => 'my-wishlist', 'uses' => 'WishlistsController@myWishlist']);
...
Route::group(['prefix' => 'shop', 'as' => 'shop.'], function () {
    ...
    Route::post('{product}/rate', ['as' => 'show', 'uses' => 'ProductsController@createRating']);
