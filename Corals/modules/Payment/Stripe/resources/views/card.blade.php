<div class="row">
    <div class="col-md-12">
        <h4>@lang('Stripe::labels.card.title')</h4>
        <hr>
        @if(user()->card_brand)
            <p><span class="text-muted">@lang('Stripe::labels.card.current_card_brand')</span> <b>{{ user()->card_brand }}</b></p>
            <p><span class="text-muted">@lang('Stripe::labels.card.current_card_last')</span> <b>{{ user()->card_last_four }}</b></p>
            <hr/>
        @endif
        <br/>
