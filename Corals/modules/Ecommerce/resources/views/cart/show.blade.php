        ...
        <div class="row">
            <div class="col-sm-12 col-md-10 col-md-offset-1">
                ...
                @if (sizeof(ShoppingCart::getItems()) > 0)
                    ...
                    <a href="{{ url('e-commerce/shop') }}" class="btn btn-primary btn">@lang('Ecommerce::labels.cart.continue_shop')</a> &nbsp;

                    <a href="{{ url('e-commerce/checkout') }}" class="btn btn-success btn">@lang('Ecommerce::labels.cart.proceed_checkout')</a>
