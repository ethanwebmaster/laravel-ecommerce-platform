...
class UsersController extends BaseController
{
    ...
    {
        try {
            $data = $request->except('picture', 'channel', 'two_factor_auth_enabled', 'password_confirmation', 'roles');
    ...
    {
        try {
            $data = $request->except('clear', 'picture', 'channel', 'two_factor_auth_enabled', 'password_confirmation', 'roles');
