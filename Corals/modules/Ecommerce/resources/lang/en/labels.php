...
return [
    ...
    'product' => [
        'add_success' => 'Your review has been added successfully',
    ...
    'wishlist' => [
        'need_login_add_product' => 'You need to login to be able to add product to wishlist',
        'product_remove_wishlist' => 'Product has been removed from wishlist successfully',
        'product_add_wishlist' => 'Product has been added to wishlist successfully',
        'title' => 'My Wishlist'
    ],
    'checkout' => [
