    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.box')
                {!! Form::model($notification_template, ['url' => url($resource_url.'/'.$notification_template->hashed_id),'method'=>$notification_template->exists?'PUT':'POST', 'class'=>'ajax-form']) !!}
                <div class="row">
                    <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="tab-content p-t-20">
                            @foreach(config('notification.supported_channels') as $channelKey => $channelName)
                                <div class="tab-pane fade in {{$loop->first ? 'active' : ''}}" id="{{$channelKey}}">
                                    <div class="row">
                                        <div class="col-md-12">
