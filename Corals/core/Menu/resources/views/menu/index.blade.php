...
@section('css')
    {!! Theme::css('plugins/nestable/nestable.css') !!}
    {!! Theme::css('plugins/fontawesome-iconpicker/css/fontawesome-iconpicker.min.css') !!}
@endsection
...
@section('js')
    {!! Theme::js('plugins/nestable/jquery.nestable.js') !!}
    {!! Theme::js('plugins/fontawesome-iconpicker/js/fontawesome-iconpicker.min.js') !!}
