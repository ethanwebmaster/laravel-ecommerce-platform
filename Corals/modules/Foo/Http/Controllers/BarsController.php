...
class BarsController extends BaseController
{
    ...
    {
        $this->setViewSharedData(['title_singular' => trans('Corals::labels.show_title', ['title' => $bar->name])]);
    ...
    {
        $this->setViewSharedData(['title_singular' => trans('Corals::labels.update_title', ['title' => $bar->name])]);
